...
public class IntegralShoppingMallAllFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        integralShoppingMallAllFragmentView = inflater.inflate(R.layout.fragment_integral_shopping_mall_all, container, false);
        unbinder = ButterKnife.bind(this, integralShoppingMallAllFragmentView);
    ...
    private void parseData() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            integralCommodityObject.setCommodityName("商品名：--全部--" + i + "---");
    ...
    static class IntegralShoppingMallAllFragmentAdapter extends BaseAdapter {
        ...
        public IntegralShoppingMallAllFragmentAdapter(Context context, List<Map<String, Object>> data) {
