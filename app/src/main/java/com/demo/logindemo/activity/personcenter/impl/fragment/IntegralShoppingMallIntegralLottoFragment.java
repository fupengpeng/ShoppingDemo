...
import com.demo.logindemo.activity.personcenter.impl.IntegralShoppingMallActivity;
import com.demo.logindemo.entity.response.commodity.IntegralCommodityList;
import com.demo.logindemo.entity.response.commodity.IntegralCommodityObject;
...
public class IntegralShoppingMallIntegralLottoFragment extends Fragment {
    ...
    private View integralShoppingMallIntegralLottoFragmentView;
     ...
     * 适配器
     */
    IntegralShoppingMallIntegralLottoFragmentAdapter integralShoppingMallIntegralLottoFragmentAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        integralShoppingMallIntegralLottoFragmentView = inflater.inflate(R.layout.fragment_integral_shopping_mall_integral_lotto, container, false);
        unbinder = ButterKnife.bind(this, integralShoppingMallIntegralLottoFragmentView);
    ...
    private void parseData() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            integralCommodityObject.setCommodityName("商品名：--积分抽奖--" + i + "---");
    ...
    static class IntegralShoppingMallIntegralLottoFragmentAdapter extends BaseAdapter {
        ...
        public IntegralShoppingMallIntegralLottoFragmentAdapter(Context context, List<Map<String, Object>> data) {
