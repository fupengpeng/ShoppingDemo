...
import com.demo.logindemo.activity.personcenter.impl.fragment.GrouponAtFragment;
import com.demo.logindemo.activity.personcenter.impl.fragment.GrouponFinishFragment;
import com.demo.logindemo.activity.personcenter.impl.fragment.GrouponUnfinishedFragment;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_activity_groupon_return:
                intent = new Intent(GrouponActivity.this, PersonActivity.class);
