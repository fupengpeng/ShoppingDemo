...
import com.demo.logindemo.activity.personcenter.impl.fragment.IntegralShoppingMallOrderAccomplishFragment;
import com.demo.logindemo.activity.personcenter.impl.fragment.IntegralShoppingMallOrderAllFragment;
import com.demo.logindemo.activity.personcenter.impl.fragment.IntegralShoppingMallOrderWaitReceivingFragment;
import com.demo.logindemo.activity.personcenter.impl.fragment.IntegralShoppingMallOrderWaitShipmentsFragment;
 ...
 * 商城订单界面
 */
public class IntegralShoppingMallOrderActivity extends BaseActivity  implements View.OnClickListener {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_activity_integral_shopping_mall_return:
                intent = new Intent(IntegralShoppingMallOrderActivity.this, PersonActivity.class);
                startActivity(intent);
                break;
